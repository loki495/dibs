...
trait DeclaresPlaceholderArgument
{
     ...
     * canUseTool callback: "invalid permission result"), so tools with nothing to configure still
     * declare one argument that the handler never reads. It is marked required in the schema, because
